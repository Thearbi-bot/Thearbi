          ...
          <div className="grid grid-cols-2 gap-3 mt-3">
            <div>
              ...
              <div className="text-lg font-mono font-bold text-white">
                {(result.kalshi_price * 100).toFixed(1)}¢
              </div>
            ...
            <div>
              ...
              <div className="text-lg font-mono font-bold text-white">
                {(result.poly_price * 100).toFixed(1)}¢
              </div>
    ...
    <div className="min-h-screen bg-zinc-950 text-white font-mono">
      ...
      <div className="border-b border-zinc-800 bg-zinc-900/80 backdrop-blur sticky top-0 z-10">
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
          <div>
            <div className="text-xs text-zinc-500 tracking-widest uppercase mb-0.5">
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center gap-3 mb-8 text-xs font-mono">
          ...
          <span className="text-zinc-400">
            {error
              ...
              : loading
              ? "Scanning..."
              : `Last scan: ${data?.last_scan ?? "—"} · Auto-refresh every 30s`}
          </span>
        </div>
        ...
        {!loading && !error && data?.results.length === 0 && (
          <div className="text-center py-20 text-zinc-600 font-mono">
            No pairs found. Check scanner is running.
          </div>
        )}
